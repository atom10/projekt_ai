...
# date dd-mm-yyyy
def generate_data(date_from, date_to, step=3):
    output = []
    ...
    while current_date <= end_date:
        ...
        print("generated data for " + current_date.strftime("%d-%m-%Y") + "  ("+str("{:.2f}".format((current_date-start_date)/(end_date-start_date)*100.0))+"%)")
